...
public class Constant {
    public static final int CONSTANT_ONESECONDINMILLISECONDS = 1000;
    public static final int CONSTANT_ONEMINUTEINMILLISECONDS = CONSTANT_ONESECONDINMILLISECONDS * 60;

    public static final int CONSTANT_MINUTESDELAYOFMAPAPI = 30;
    public static final int SLIDERMAP_NUMBEROFMAPS = 5;
    public static final int SLIDERMAP_MINUTESINTERVAL = 60;

    public static final String CONSTANT_MAPAPIWEBSITE = "http://www.jma.go.jp";
    public static final String CONSTANT_MAPAPIIMAGE = CONSTANT_MAPAPIWEBSITE + "/jp/gms/imgs/5/infrared/1/%s00-00.png";
